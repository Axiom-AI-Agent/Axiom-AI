...
## Corpus Check
- 424 files · ~530,985 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4342 nodes · 8941 edges · 278 communities (239 shown, 39 thin omitted)
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 1698 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f19d4a20`
...
3. `IdentityContext` - 69 edges
4. `AgentState` - 59 edges
5. `DayOfWeek` - 58 edges
6. `ChatChannel` - 55 edges
7. `OccurrenceStatus` - 55 edges
...
## Communities (278 total, 39 thin omitted)

### Community 0 - "Admissions Onboarding"
Cohesion: 0.04
Nodes (77): ClassFormState, emptyForm, aiRequest(), analyzeFaqs(), asSchedule(), asScheduleList(), assignEscalation(), BroadcastFailure (+69 more)
...
Cohesion: 0.24
Nodes (38): ChatChannel, EnrollmentStatus, EscalationStatus, ClassAnalyticsComparisonResponse, ClassAnalyticsMetric, ClassBase, ClassCreate, ClassHumanModeUpdate (+30 more)
...
Cohesion: 0.12
Nodes (26): main(), collection_info(), title_from_filename(), _attach_document_ids(), delete_document_ingest(), embed_texts(), ingest_documents(), load_tenant_docs() (+18 more)
...
Cohesion: 0.12
Nodes (23): classify_confirmation(), reset_pending_questions(), ctx(), _decision_graph(), asyncio, fixture, parametrize, Chat-turn regressions for B4 (escalation confirmation) and B5 (bare links). (+15 more)
...
Cohesion: 0.13
Nodes (25): _enrich_escalations(), EscalationActionResponse, list_escalations(), notify_student(), _phone_digits(), _phones_match(), Any, BaseModel (+17 more)
...
Cohesion: 0.11
Nodes (20): build_recall_context(), format_student_profile(), Build recall context (student profile + ST turns) before the decision graph., Structured student block for router and agent prompts., Return (full_router_context, student_profile_context) for one chat turn., FakeDrive, FakeMemoryTool, FakeRag (+12 more)
...
Cohesion: 0.14
Nodes (24): _breadcrumb(), _contextualize(), fixed_chunk(), _is_table_line(), _page_of(), parent_child_chunk(), Any, Text chunking strategies — fixed + parent-child, markdown structure aware.  Pare (+16 more)
...
Cohesion: 0.18
Nodes (13): AdmissionsAgent, AdmissionsAgentResult, _class_label(), _last_user_text(), Any, Admissions agent node — multi-turn onboarding via CRM MCP tools., Answer "I want to join X" against real enrollment rows (B1, B2).          Which, Append the unfinished flow's reminder to an interrupting answer. (+5 more)
...
Cohesion: 0.27
Nodes (15): ResourceAgent, FakeDrive, FakeLowConfidenceRag, FakeRag, Any, asyncio, Resource agent node tests (direct tool clients, no MCP)., test_resource_agent_asks_before_low_confidence_handoff() (+7 more)
...
Cohesion: 0.16
Nodes (17): Base, Represents a tuition class offered by a tenant., SubjectClass, create_class(), delete_class(), get_class(), get_classes(), _parse_fee_cycle() (+9 more)
...
Cohesion: 0.21
Nodes (9): inter, metadata, spaceGrotesk, applyTheme(), readStoredTheme(), Theme, ThemeContext, ThemeContextValue (+1 more)
...
### Community 150 - "Admissions Onboarding 19"
Cohesion: 0.27
...
Cohesion: 0.38
Nodes (9): StaffRole, create_staff(), list_staff(), get, patch, Session, _to_response(), update_staff() (+1 more)
...
### Community 159 - "identity init py"
Cohesion: 0.31
...
### Community 161 - "Return the latest"
Cohesion: 0.33
...
### Community 162 - "rag templates py"
Cohesion: 0.33
...
### Community 163 - "Dashboard Module 19"
Cohesion: 0.25
Nodes (4): chat_result(), client(), fixture, HTTP dev chat endpoint tests.

### Community 164 - "Dashboard Module 20"
Cohesion: 0.25
...
### Community 165 - "Dashboard Module 21"
Cohesion: 0.25
...
### Community 169 - "OpenRouter LLM Access"
Cohesion: 0.25
...
### Community 170 - "axiom ai backend"
Cohesion: 0.36
...
### Community 171 - "agents tools init"
Cohesion: 0.36
...
### Community 174 - "routers tools init"
Cohesion: 0.25
Nodes (3): client(), fixture, Phase 0 health endpoint tests.

### Community 175 - "Twilio Webhook"
Cohesion: 0.29
...
### Community 177 - "MCP Integration 6"
Cohesion: 0.29
...
### Community 181 - "src services init"
Cohesion: 0.43
...
### Community 182 - "services prompts init"
Cohesion: 0.29
Nodes (7): Request, Receive Telegram updates for a single tenant bot.      Always acknowledges with, telegram_webhook(), ensure_tenant_bot(), is_tenant_bot_error(), BaseException, Fail fast if this webhook path does not map to a configured tenant bot.

### Community 183 - "rag service init"
Cohesion: 0.43
Nodes (3): _page_lacks_text(), True when a page's text layer yielded too little to be real content., TestPageLacksText

### Community 184 - "tests init py"
Cohesion: 0.38
Nodes (6): active_tenant_scope(), client(), client_no_tenant_override(), fixture, Shared pytest bootstrap., # IMPORTANT:

### Community 185 - "mockData.ts"
Cohesion: 0.33
Nodes (4): FakeCrm, asyncio, Escalation agent tests., test_escalation_agent_creates_talk_to_tutor_ticket()

### Community 187 - "app/page.tsx"
Cohesion: 0.29
Nodes (6): Axiom AI — Staff Dashboard, Backend, Build for production, Frontend, Layout, Prerequisites

### Community 188 - "overview.ts"
Cohesion: 0.33
Nodes (5): Demo script — Student chat only (~5 min), Narrative, Payment approval (outside this UI), Steps, Troubleshooting

### Community 189 - "postcss.config.js"
Cohesion: 0.33
...
### Community 190 - "student-chat/tailwind.config.js"
Cohesion: 0.33
...
### Community 191 - "Project Planning.md"
Cohesion: 0.33
...
### Community 192 - "agents/tools/__init__.py"
Cohesion: 0.60
...
- **Why does `ChatChannel` connect `Admissions Onboarding 7` to `Resource Agent`, `Demo Chat Lifecycle`, `Test Suite 6`, `Student Chat Deps 3`, `Dashboard Module 2`, `Dashboard Frontend Deps`, `Langfuse Runtime 2`, `Drive Tooling`, `Dashboard Module 7`, `Dashboard Module 3`, `Workshop Exploration`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ScheduleService` connect `Admissions Onboarding 4` to `Admissions Onboarding 3`, `RAG Ingest Pipeline 3`, `RAG Ingest Pipeline 4`, `Decision Graph 2`, `Admissions Onboarding 13`, `check python py`, `Decision Graph`, `Supabase DB Client 4`, `TwilioMessagingClient`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `IdentityContext` connect `Student Chat Deps 3` to `Student Chat Deps 5`, `Chat Message Pipeline`, `Invoice DB Layer`, `Escalation Routes`, `Test Suite 6`, `Dashboard Frontend Deps 4`, `Dashboard Module`, `Design Double Diamond`, `kb_documents.py`, `Drive Tooling`, `Supabase DB Client 2`, `Workshop Exploration 2`?**
