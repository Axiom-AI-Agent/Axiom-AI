...
## Corpus Check
- 385 files · ~502,850 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3826 nodes · 7783 edges · 265 communities (225 shown, 40 thin omitted)
...
Cohesion: 0.06
Nodes (33): classify_resource_subpath(), DirectDriveClient, DirectScheduleClient, DriveClient, _format_day_schedule(), _format_schedule_reply(), _format_single_class(), _format_week_schedule() (+25 more)
...
Cohesion: 0.11
Nodes (22): _noop_emit(), Any, EmitFn, Single async entry for one chat turn: decision graph → orchestrator (or OOS shor, _routes_from_patch(), run_chat_turn(), classify_confirmation(), get_pending_low_confidence_question() (+14 more)
...
Cohesion: 0.13
Nodes (17): DashboardLayoutProps, ProtectedDashboard(), Header(), HeaderProps, ToastContainer(), toastStyles(), useAuth(), TenantContext (+9 more)
...
Cohesion: 0.16
Nodes (21): Staff reply to a student via WhatsApp.      Persists the message as role=system, send_staff_message(), list_files(), Debug REST — Drive tool (same surface as drive_server MCP)., search(), _ingest_result(), _minimal_docx(), _post() (+13 more)
...
Cohesion: 0.16
Nodes (25): build_guardrail_system_prompt(), build_payment_ack_reply(), build_payment_missing_media_reply(), build_resource_drive_list_reply(), build_resource_drive_pick_reply(), build_resource_rag_reply(), build_router_prompt(), _drive_folder_label() (+17 more)
...
Cohesion: 0.14
Nodes (15): _fallback_multi(), get_query_router(), heuristic_route(), _last_user_text(), _normalize_action(), _pattern_score(), Any, QueryRouter (+7 more)
...
Cohesion: 0.14
Nodes (21): ResourceAgent, FakeDrive, Any, asyncio, Class-scoped RAG retrieval tests., test_kb_search_forwards_class_ids_to_rag_service(), test_resource_agent_blocks_enrolled_without_class_ids(), test_resource_agent_passes_enrolled_class_ids_to_rag() (+13 more)
...
Cohesion: 0.13
Nodes (23): main(), title_from_filename(), _attach_document_ids(), delete_document_ingest(), embed_texts(), ingest_documents(), load_tenant_docs(), prepare_upload_ingest() (+15 more)
...
Cohesion: 0.07
Nodes (39): ChatResult, EscalationAgent, EscalationAgentResult, _last_user_text(), Escalation agent — talk-to-tutor requests → dashboard inbox., run_escalation_agent(), _last_user_text(), PaymentAgentResult (+31 more)
...
Cohesion: 0.22
Nodes (18): create_student(), delete_student(), enroll_student(), get_student(), get_student_by_phone(), get_students(), delete, get (+10 more)
...
Cohesion: 0.14
Nodes (20): MultiRouteDecision, RouteDecision, _mock_oos_graph(), Any, asyncio, Fast E2E wiring tests (mocked LLM — BookMe / Week 13 decision_graph test pattern, Minimal stand-in — records whether orchestrator path runs (BookMe AI pattern)., _RecordingOrchestrator (+12 more)
...
Cohesion: 0.08
Nodes (38): cancel_schedule(), create_exception(), create_schedule(), delete_exception(), get_schedule(), list_exceptions(), list_schedules(), DashboardTenant (+30 more)
...
Cohesion: 0.10
Nodes (18): get_db(), _load_env(), Load env from Dashboard, shared AI-backend, or repo root., get_tenant_id(), Authenticated tenant scope for dashboard API requests., Base, Represents a student registered under a tenant., Student (+10 more)
...
Cohesion: 0.22
Nodes (9): build_escalation_ack_reply(), get_flagged_abusive_reply(), normalize_language_pref(), Human-readable hint for STT. None for English so Gemini auto-detects., Map stored / incoming codes to en | si | ta. Unknown values become en., stt_language_hint(), test_flagged_abusive_localized(), test_normalize_language_pref_aliases() (+1 more)
...
Cohesion: 0.10
Nodes (23): AnalyticsPage(), humanizeReason(), ClassesPage(), IngestContent(), OverviewPage(), ChartCard(), ChartCardProps, ChatTurn (+15 more)
...
Cohesion: 0.18
Nodes (3): AdminRegistration, EmailStr, field_validator
...
Cohesion: 0.18
Nodes (13): analyze_tenant_faqs(), Any, DashboardTenant, FAQ intelligence endpoint for dashboard staff., Cluster recent student questions into recurring FAQ themes., analyze_faqs(), _clean_message(), FAQCluster (+5 more)
...
Cohesion: 0.15
Nodes (10): list_classes(), Any, get, Subject class listing — dashboard API., List available classes for a tenant., get, root(), escalation_websocket() (+2 more)
...
- **Why does `CrmTool` connect `Decision Graph` to `Demo Chat Lifecycle`, `escalation_reasons.py`, `.resolve_escalation`, `Admissions Onboarding 6`, `.create_escalation`, `Drive Tooling`, `Workshop Exploration`, `register_student`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `ScheduleService` connect `MCP Integration 2` to `Chat Message Pipeline 7`, `IdentityResolver`, `RAG Ingest Pipeline 3`, `Admissions Onboarding 5`, `Drive Tooling`, `API Chat Schemas`, `Escalation Routes 7`, `Resource Agent 2`, `Langfuse Runtime 3`, `Resource Agent 3`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `ChatChannel` connect `Invoice DB Layer 2` to `Test Suite 3`, `Dashboard Module`, `test_identity_recall.py`, `Escalation Routes 8`, `Workshop Exploration`, `Dashboard API Routes 2`, `PaymentStatusUpdate`, `Agent Orchestrator`, `Dashboard ORM Models`, `Phase 5 — Escalations + staff chat`, `Admissions Onboarding 20`?**
